...
1. I will be Using the D3 library to read in `samples.json`.
...
8. Update the chart whenever a new sample is selected.

![Weekly Washing Frequency Gauge](Images/gauge.png)

And finally the Project is outlayed this way:
![hw](Images/hw02.png)
